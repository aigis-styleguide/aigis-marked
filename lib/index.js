...
var MarkedCustomRenderer = (function(MarkedRenderer) {
  function MarkedCustomRenderer(options) {
    ...
    this._enableSyntaxHighlight(isHighlight, langPrefix);
  }
  ...
  MarkedCustomRenderer.prototype._enableSyntaxHighlight = function(flag, langPrefix) {
    if (flag) {
      marked.setOptions({highlight: require('./highlight'), langPrefix: langPrefix});
    }
  };
